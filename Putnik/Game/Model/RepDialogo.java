...
public class RepDialogo {
    ...
    public static Dialogo[] cap3cen3 = {
            ...
            new Dialogo("NARRADOR", "O quarto nome está riscado. Só é possível ler as últimas letras: \"...MIKHAIL\"."),
    ...
    public static Dialogo[] cap3cen4 = {
            ...
            new Dialogo("NARRADOR", "Deyv toca a maçaneta. A luz apaga por um segundo.\n" +
                    "Quando retorna, a porta mostra um corredor cheio de pessoas sem rosto."),
    ...
    public static Dialogo[] cap4cen1 = {
            ...
            new Dialogo("NARRADOR", "A entrada subterrânea fica abaixo da estação.\n" +
                    "Não existe placa, escada ou indicação de que o lugar deveria estar ali.\n" +
                    "Mesmo assim, os três encontram uma passagem escondida sob a plataforma."),
    ...
    public static Dialogo[] cap4cen2 = {
            ...
            new Dialogo("ELENA", "Cada grupo acredita que pode escapar sem pagar um preço. Depois descobre que a prisão exige alguém que escolha ficar."),
    ...
    public static Dialogo[] cap4cen3 = {
            ...
            new Dialogo("NARRADOR", "Deyv tira do bolso uma fotografia antiga. Nela aparecem ele, Mikhail e outras pessoas diante da mesma estação."),
    ...
    public static Dialogo[] cap5cen1 = {
            ...
            new Dialogo("NARRADOR", "Ao redor do grupo flutuam pedaços de prédios, fotografias, relógios e objetos encontrados nos capítulos anteriores.\n" +
    ...
    public static Dialogo[] cap5cen2 = {
            ...
            new Dialogo("NARRADOR", "A estrutura mostra lembranças dos três.\n" +
                    "Serj vê sua casa, Ibis vê sua família e Deyv vê pessoas que ele não conseguiu salvar antes."),
    ...
    // FINAL 1 -SERJ E IBIS ESCAPAM
    public static Dialogo[] final1 = {

            new Dialogo("NARRADOR", "A porta finalmente se abre. Do outro lado existe uma rua comum, iluminada pela luz fraca da manhã.\n" +
                    "Depois de tudo o que passaram, aquele cenário parece quase estranho demais para ser real."),
            new Dialogo("SERJ", "Então... acabou."),
            new Dialogo("IBIS", "Acho que sim."),
            new Dialogo("NARRADOR", "Serj atravessa lentamente a passagem. Ibis vem logo atrás.\n" +
                    "Por alguns segundos, nenhum dos dois consegue dizer mais nada."),
            new Dialogo("SERJ", "E o Deyv?"),
            new Dialogo("IBIS", "Ele não veio."),
            new Dialogo("NARRADOR", "Serj olha novamente para a passagem. Do outro lado, Deyv permanece parado no salão escuro."),
            new Dialogo("DEYV", "Você tomou sua decisão."),
            new Dialogo("SERJ", "Eu não podia continuar seguindo alguém em quem não conseguia confiar."),
            new Dialogo("DEYV", "Talvez você tenha feito a escolha certa para sobreviver."),
            new Dialogo("NARRADOR", "Deyv não tenta atravessar. Ele apenas observa enquanto a passagem começa a desaparecer."),
            new Dialogo("IBIS", "Serj, vamos."),
            new Dialogo("NARRADOR", "Serj se afasta. Pela última vez, olha para Deyv antes que a porta se feche completamente."),
            new Dialogo("SERJ", "...Adeus."),
            new Dialogo("NARRADOR", "A passagem desaparece.\n\n" +
                    "Serj e Ibis estão novamente no mundo normal. As ruas continuam silenciosas por alguns instantes,\n" +
                    "até que o som de carros e pessoas começa a retornar."),
            new Dialogo("NARRADOR", "Mas Serj sabe que alguma coisa mudou.\n" +
                    "Ele encontrou a saída, mas deixou para trás alguém que talvez nunca tenha tido uma oportunidade de escolha."),
            new Dialogo("NARRADOR", "[FINAL 01 — A VOLTA]")

    };


    // FINAL 2 - SERJ E DEYV ESCAPAM
    public static Dialogo[] final2 = {

            new Dialogo("NARRADOR", "A passagem se abre novamente. Desta vez, Deyv está ao lado de Serj."),
            new Dialogo("SERJ", "Você vem comigo."),
            new Dialogo("DEYV", "E Ibis?"),
            new Dialogo("NARRADOR", "Serj olha para trás. Ibis permanece alguns metros distante, diante do salão escuro."),
            new Dialogo("IBIS", "Não precisa olhar assim para mim."),
            new Dialogo("SERJ", "Eu vou voltar."),
            new Dialogo("IBIS", "Você sabe que pode não conseguir."),
            new Dialogo("SERJ", "Eu sei."),
            new Dialogo("NARRADOR", "Serj e Deyv atravessam a passagem. No mesmo instante, ela começa a desaparecer."),
            new Dialogo("IBIS", "Serj!"),
            new Dialogo("NARRADOR", "Serj tenta voltar, mas já é tarde demais.\n\n" +
                    "O mundo normal recebe os dois em completo silêncio. Deyv cai de joelhos no asfalto, respirando profundamente."),
            new Dialogo("SERJ", "Nós conseguimos."),
            new Dialogo("DEYV", "Não."),
            new Dialogo("SERJ", "O que foi?"),
            new Dialogo("DEYV", "Você não entendeu ainda."),
            new Dialogo("NARRADOR", "Deyv retira do bolso a fotografia encontrada na casa subterrânea."),
            new Dialogo("DEYV", "Eu conhecia aquele lugar antes de tudo isso acontecer."),
            new Dialogo("SERJ", "Você disse que só tinha estado lá uma vez."),
            new Dialogo("DEYV", "Eu menti."),
            new Dialogo("NARRADOR", "Deyv revela que encontrou os registros anos antes e que procurava uma forma de retornar ao local.\n" +
                    "Ele sabia que a prisão precisava de três pessoas para completar seu ciclo."),
            new Dialogo("SERJ", "Então foi você."),
            new Dialogo("DEYV", "Eu não sabia que vocês seriam levados junto comigo."),
            new Dialogo("SERJ", "Mas você sabia o suficiente."),
            new Dialogo("NARRADOR", "Serj olha para a rua vazia. Pela primeira vez, entende que Ibis permaneceu naquele lugar por causa das escolhas que ele próprio fez."),
            new Dialogo("SERJ", "Eu abandonei ele."),
            new Dialogo("DEYV", "Nós dois fizemos escolhas."),
            new Dialogo("SERJ", "Não. A escolha foi minha."),
            new Dialogo("NARRADOR", "Deyv permanece em silêncio."),
            new Dialogo("NARRADOR", "Enquanto o mundo normal continua sua rotina, Serj percebe uma pequena marca em seu braço.\n" +
                    "O mesmo símbolo encontrado nas paredes da prisão."),
            new Dialogo("SERJ", "...Ela veio comigo.")
    };


    // FINAL 3 - TODOS FICAM
    public static Dialogo[] final3 = {

            new Dialogo("NARRADOR", "A porta permanece aberta diante dos três. Nenhum deles consegue decidir quem deve atravessar."),
            new Dialogo("IBIS", "Talvez exista outra saída."),
            new Dialogo("DEYV", "Não existe."),
            new Dialogo("SERJ", "Tem que existir."),
            new Dialogo("NARRADOR", "Os três procuram novamente por uma passagem.\n" +
                    "Caminham pelos mesmos corredores, retornam às mesmas salas e encontram os mesmos objetos que já haviam visto."),
            new Dialogo("NARRADOR", "O lugar começa a repetir suas próprias estruturas."),
            new Dialogo("IBIS", "Nós já passamos por aqui."),
            new Dialogo("SERJ", "Eu sei."),
            new Dialogo("DEYV", "Estamos voltando para o mesmo ponto."),
            new Dialogo("NARRADOR", "O relógio continua marcando 04:00. O tempo não avança mais."),
            new Dialogo("IBIS", "Serj... quanto tempo estamos aqui?"),
            new Dialogo("SERJ", "Eu não sei."),
            new Dialogo("NARRADOR", "As lembranças começam a desaparecer.\n" +
                    "Primeiro são pequenos detalhes. Depois nomes, lugares e acontecimentos inteiros."),
            new Dialogo("SERJ", "Ibis..."),
            new Dialogo("IBIS", "Sim?"),
            new Dialogo("SERJ", "Nós éramos amigos antes disso, não éramos?"),
            new Dialogo("IBIS", "...Eram."),
            new Dialogo("NARRADOR", "Deyv permanece sentado próximo à parede, encarando o chão."),
            new Dialogo("SERJ", "Deyv?"),
            new Dialogo("NARRADOR", "Deyv não responde."),
            new Dialogo("IBIS", "Ele está olhando para alguma coisa."),
            new Dialogo("NARRADOR", "No chão existe uma fotografia antiga.\n" +
                    "Deyv a segura por alguns segundos, mas parece incapaz de reconhecer as pessoas nela."),
            new Dialogo("DEYV", "Eu conhecia essas pessoas."),
            new Dialogo("SERJ", "Quem são elas?"),
            new Dialogo("DEYV", "...Não lembro."),
            new Dialogo("NARRADOR", "O silêncio volta a tomar conta do lugar."),
            new Dialogo("NARRADOR", "Os três permanecem reunidos no mesmo salão. Nenhum deles tenta mais procurar a saída."),
            new Dialogo("NARRADOR", "Serj encara Ibis. Ibis encara Deyv. Deyv permanece com os olhos vazios diante da fotografia."),
            new Dialogo("NARRADOR", "Não há gritos. Não há fuga. Apenas a permanência."),
